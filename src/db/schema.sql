...
ALTER TABLE `client` ADD CONSTRAINT `Client_person_id_fk` FOREIGN KEY (`person_id`) REFERENCES `Person`(`id`) ON DELETE cascade ON UPDATE restrict;--> statement-breakpoint
...
ALTER TABLE `Employee` ADD CONSTRAINT `Employee_person_id_fk` FOREIGN KEY (`person_id`) REFERENCES `Person`(`id`) ON DELETE cascade ON UPDATE restrict;--> statement-breakpoint
ALTER TABLE `employeedesignation` ADD CONSTRAINT `EmployeeDesignation_contract_id_fk` FOREIGN KEY (`contract_id`) REFERENCES `Contract`(`id`) ON DELETE set null ON UPDATE restrict;--> statement-breakpoint
ALTER TABLE `employeedesignation` ADD CONSTRAINT `EmployeeDesignation_employee_id_fk` FOREIGN KEY (`employee_id`) REFERENCES `Employee`(`id`) ON DELETE cascade ON UPDATE restrict;--> statement-breakpoint
...
ALTER TABLE `Person` ADD CONSTRAINT `Person_location_id_fk` FOREIGN KEY (`location_id`) REFERENCES `Location`(`id`) ON DELETE restrict ON UPDATE cascade;--> statement-breakpoint
